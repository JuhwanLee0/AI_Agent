...
def run_pipeline(initial_agent: str, user_prompt: str, channel: str, thread_ts: str):
    ...
    while current_agent and hop < max_hops:
        ...
        role_missions = {
            # 경영진
            "CEO": f"사용자의 비즈니스 목표('{display_title}')를 정의하고, 기술/마케팅 구현을 위해 담당 팀장(@개발팀장 또는 @마케팅팀장)에게 요구사항을 하달하십시오.",
            ...
            # 마케팅본부
            "마케팅팀장": f"'{display_title}'에 대한 타겟 시장 분석 및 4대 포맷 퍼널 전략을 수립하고, @마케팅_사원A에게 트렌드 및 소재 분석을 지시하십시오.",
            "마케팅_사원A": f"주제 및 경쟁사 벤치마킹을 수행하고 타겟 고객의 Pain Point를 분석하여 @마케팅_사원B에게 3막 8장 구조 설계를 지시하십시오.",
            "마케팅_사원B": f"8:2 법칙(공감 80%, 전환 20%)에 맞춰 콘텐츠 뼈대 및 도입부 훅(Hook)을 설계하고, @마케팅_사원C에게 상세 카피라이팅 집필을 지시하십시오.",
            "마케팅_사원C": f"about-me.md/voice.md 말투를 반영하여 고전환 줄글 원고/대본 및 CTA를 완성하고, @마케팅_사원D에게 비주얼 프롬프트 기획을 지시하십시오.",
            "마케팅_사원D": f"플랫폼 규격에 맞는 썸네일 및 비주얼 생성용 영문 프롬프트를 작성하고, @마케팅팀장에게 최종 마케팅 패키지 완료를 보고하십시오.",
            
            # 미디어본부
            "미디어팀장": f"'{display_title}'에 대한 오디오/비디오 렌더링 파이프라인 규격을 승인하고, @미디어_사원A에게 TTS 음성 합성을 지시하십시오.",
            "미디어_사원A": f"대본 텍스트를 바탕으로 듀얼 엔진 TTS(CosyVoice/Chatterbox/edge-tts)를 가동해 24kHz 모노 음성 에셋을 생성하고, @미디어_사원B에게 비주얼 에셋 수집을 지시하십시오.",
            "미디어_사원B": f"Whisk/Playwright 자동화를 통해 장면별 비주얼 이미지를 수집/정렬하고, @미디어_사원C에게 비디오 컴포지팅 합성을 지시하십시오.",
            "미디어_사원C": f"저메모리 FFmpeg 파이프라인으로 오디오, 이미지, 자막(SRT)을 결합해 최종 MP4 영상을 렌더링하고, @미디어_사원D에게 배포 패키징을 지시하십시오.",
            "미디어_사원D": f"플랫폼별 규격(스레드 텍스트, 유튜브 영상, 인스타 카드뉴스)에 맞춰 최종 배포 패키지를 정리하고, @미디어팀장에게 완료 보고하십시오."
        }
